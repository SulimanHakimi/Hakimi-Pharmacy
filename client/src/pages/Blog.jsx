...
function BlogPage() {
  ...
  return (
    <>
      <Helmet>
        <title>جدیدترین مقالات طبی</title>
        <meta
          name="keywords"
          content="دواخانه افغانستان, افغانستان, خرید دواخانه آنلاین, سلامتی, رفاه, مقالات دوایی"
        />
        <meta property="og:title" content="جدیدترین مقالات طبی" />

        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${import.meta.env.CLIENT_UR}/blog`} />
