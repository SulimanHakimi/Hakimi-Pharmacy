  ...
  return (
    <>
      <section className="py-12 md:py-16 bg-white">
        <Helmet>
          <title> دواخانه آنلاین در افغانستان - خرید دوا آنلاین</title>
          <meta
            name="description"
            content="خرید دوا آنلاین از اولین دواخانه آنلاین در افغانستان. محصولات دوایی متنوع و با کیفیت را از دواخانه آنلاین ما تهیه کنید."
          />
          <meta
            name="keywords"
            content="دواخانه آنلاین, خرید دوا آنلاین, افغانستان, دوا آنلاین, دواخانه, دواخانه آنلاین افغانستان"
          />
          <meta property="og:title" content="دواخانه آنلاین در افغانستان" />
          <meta
            property="og:description"
            content="آشنایی با اولین دواخانه آنلاین در افغانستان. خرید دوا آنلاین با ارسال سریع و آسان."
          />
          <meta property="og:type" content="website" />
          <meta
            property="og:url"
            content={`${import.meta.env.CLIENT_UR}/shop`}
          />
